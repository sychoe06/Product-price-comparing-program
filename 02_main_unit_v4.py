...
other options later in the program. The error message is more generic now and
made it more clear as to what kind of units to enter in the input statement
"""
