"""Save data in file - based on 09_save_data_in_file_v1 (Testing 2)
Instead of automatically saving the data of the products into files, I wanted
to give users a choice on whether they want to save the details or not. So I
used an input statement to ask if users want to save the products details into
an excel file.
"""
import pandas
...
# Test data (test case #2)
products_within_budget = [["Not Greggs", 1.50], ["Nescafe", 0.06]]
...
save_data = input("\nSave products details in excel files? (Y/N): ").upper()
if save_data == "Y":
